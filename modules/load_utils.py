...
def obj_to_nx(data):
    ...
    for i in range(num_atoms):
        ...
        G.add_node(i, x_feat=atom_features[i])
        pass
    ...
    for j in range(0, num_bonds, 2):
        ...
        if not G.has_edge(begin_idx, end_idx):
            ...
            G.add_edge(begin_idx, end_idx, bond_feat=edge_attr[j])
    # if hasattr(data, "task_emb"):
    #     G.task_emb = data.task_emb
    # if hasattr(data, "y"):
    #     G.y = data.y
    if hasattr(data, "num_node"):
        G.num_node = data.num_node
...
def nx_to_obj(G):
    ...
    # if hasattr(G, "task_emb"):
    #     data.task_emb = G.task_emb
    # if hasattr(G, "y"):
    #     data.y = G.y
    if hasattr(G, "num_node"):
        data.num_node = G.num_node
