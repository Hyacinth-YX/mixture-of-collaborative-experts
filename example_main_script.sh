...
CUDA_VISIBLE_DEVICES=0 python main.py --task allseed-35ds-scaf-60ex-gnn --model GNN --device cuda --epoch 100 --emb_dim 1024 --lr 1e-2 --eta_min 1e-8 --seed 0 --train_times 10 --dataset cls --dataset cls --drop_ratio 0.3 --use_valid --full_evaluate --num_layer 4 --full_eval_step 1 --batch_size 512  --JK last --graph_pooling sum --gnn_type gin
