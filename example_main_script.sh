############## Full Evaluate ###################
# Train in 35 datasets using GNN in Multi-task (Scaffold Split)
CUDA_VISIBLE_DEVICES=0 python main.py --task allseed-35ds-scaf-60ex-gnn --model TRMoCE --device cuda --epoch 100 --num_experts 60 --emb_dim 300 --lr 1e-2 --eta_min 1e-8 --seed 0 --k 4 --emb_desc --dataset cls --drop_ratio 0.3 --num_layer 4 --full_evaluate --full_eval_step 1 --batch_size 512 --num_g_experts 6 --use_valid --train_times 10 --sag_pool --open_dy --iattvec_loss

# Train in 35 datasets using MoE-GNN in Multi-task (Scaffold Split)
CUDA_VISIBLE_DEVICES=0 python main.py --task allseed-35ds-scaf-60ex-moe --model TRMoCE --device cuda --epoch 100 --num_experts 60 --emb_dim 300 --lr 1e-2 --eta_min 1e-8 --seed 0 --k 4 --emb_desc --dataset cls --drop_ratio 0.3 --num_layer 4 --full_evaluate --full_eval_step 1 --batch_size 512 --num_g_experts 6 --use_valid --train_times 10 --sag_pool --open_dy --iattvec_loss

# Train in 35 datasets using MoCE-GNN in Multi-task (Scaffold Split)
CUDA_VISIBLE_DEVICES=0 python main.py --task allseed-35ds-scaf-60ex-moce --model TRMoCE --device cuda --epoch 100 --num_experts 60 --emb_dim 300 --lr 1e-2 --eta_min 1e-8 --seed 0 --k 4 --emb_desc --dataset cls --drop_ratio 0.3 --num_layer 4 --full_evaluate --full_eval_step 1 --batch_size 512 --num_g_experts 6 --use_valid --train_times 10 --sag_pool --open_dy --iattvec_loss

############## Ablation Study ###################
# PS: SAG+ATTLoss=ESProjection
# MoCE
CUDA_VISIBLE_DEVICES=0 python main.py --task ablation-scaf-moce-SAG-ATTLoss-ESLoss --model TRMoCE --device cuda --sag_pool --iattvec_loss --open_dy --epoch 100 --num_experts 30 --emb_dim 300 --lr 1e-2 --eta_min 1e-8 --seed 0 --k 4 --emb_desc --dataset cls --drop_ratio 0.3 --num_layer 4 --full_evaluate --full_eval_step 1 --batch_size 512 --num_g_experts 6 --dataset_comb "SkinReaction,CYP2C9_Veith,CYP3A4_Veith,AMES,CYP2C19_Veith,CYP1A2_Veith,CYP3A4_Substrate_CarbonMangels,Pgp_Broccatelli,hERG_Karim,DILI" --use_valid --train_times 10
# MoCE w/o ESLoss
